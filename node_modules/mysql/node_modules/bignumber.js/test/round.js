...
var count = (function round(BigNumber) {
    ...
    assertException(function () {new BigNumber('12.345').round('NaN')}, ".round('NaN')");
    assertException(function () {new BigNumber('12.345').round([])}, ".round([])");
    assertException(function () {new BigNumber('12.345').round({})}, ".round({})");
    assertException(function () {new BigNumber('12.345').round('')}, ".round('')");
    assertException(function () {new BigNumber('12.345').round(' ')}, ".round(' ')");
    assertException(function () {new BigNumber('12.345').round('hello')}, ".round('hello')");
    assertException(function () {new BigNumber('12.345').round('\t')}, ".round('\t')");
    assertException(function () {new BigNumber('12.345').round(new Date)}, ".round(new Date)");
    assertException(function () {new BigNumber('12.345').round(new RegExp)}, ".round(new RegExp)");
    assertException(function () {new BigNumber('12.345').round(7.5)}, ".round(7.5)");
    assertException(function () {new BigNumber('12.345').round('1.1e1')}, ".round('1.1e1')");

    assertException(function () {new BigNumber('12.345').round('-1')}, ".round('-1')");
    assertException(function () {new BigNumber('12.345').round(-23)}, ".round(-23)");
    assertException(function () {new BigNumber('12.345').round(1e9 + 1)}, ".round(1e9 + 1)");
    assertException(function () {new BigNumber('12.345').round(1e9 + 0.1)}, ".round(1e9 + 1)");
    assertException(function () {new BigNumber('12.345').round('-0.01')}, ".round('-0.01')");
    assertException(function () {new BigNumber('12.345').round('-1e-1')}, ".round('-1e-1')");
    ...
    assertException(function () {new BigNumber('12.345').round(u, NaN)}, ".round(u, NaN)");
    assertException(function () {new BigNumber('12.345').round(u, 'NaN')}, ".round(u, 'NaN')");
    assertException(function () {new BigNumber('12.345').round(u, [])}, ".round(u, [])");
    assertException(function () {new BigNumber('12.345').round(u, {})}, ".round(u, {})");
    assertException(function () {new BigNumber('12.345').round(u, '')}, ".round(u, '')");
    assertException(function () {new BigNumber('12.345').round(u, ' ')}, ".round(u, ' ')");
    assertException(function () {new BigNumber('12.345').round(u, 'hello')}, ".round(u, 'hello')");
    assertException(function () {new BigNumber('12.345').round(u, '\t')}, ".round(u, '\t')");
    assertException(function () {new BigNumber('12.345').round(u, new Date)}, ".round(u, new Date)");
    assertException(function () {new BigNumber('12.345').round(u, new RegExp)}, ".round(u, new RegExp)");
    assertException(function () {new BigNumber('12.345').round(u, 7.5)}, ".round(u, 7.5)");
    assertException(function () {new BigNumber('12.345').round(u, '1.1e1')}, ".round(u, '1.1e1')");

    assertException(function () {new BigNumber('12.345').round(u, '-1')}, ".round('u, -1')");
    assertException(function () {new BigNumber('12.345').round(u, -23)}, ".round(u, -23)");
    assertException(function () {new BigNumber('12.345').round(u, 8.01)}, ".round(u, 8.01)");
    assertException(function () {new BigNumber('12.345').round(u, 9)}, ".round(u, 9)");
    assertException(function () {new BigNumber('12.345').round(u, -1)}, ".round(u, -1)");
    assertException(function () {new BigNumber('12.345').round(u, '-0.01')}, ".round(u, '-0.01')");
    assertException(function () {new BigNumber('12.345').round(u, '-1e-1')}, ".round(u, '-1e-1')");
    assertException(function () {new BigNumber('12.345').round(u, Infinity)}, ".round(u, Infinity)");
    assertException(function () {new BigNumber('12.345').round(u, '-Infinity')}, ".round(u, '-Infinity')");
