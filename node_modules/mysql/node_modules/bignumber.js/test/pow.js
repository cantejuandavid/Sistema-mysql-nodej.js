...
var count = (function pow(BigNumber) {
    ...
    assertException(function () {new BigNumber(2).pow('0.04e2')}, ".pow('0.04e2')");
    ...
    assertException(function () {new BigNumber('12.345').pow('')}, ".pow('')");
    assertException(function () {new BigNumber('12.345').pow(' ')}, ".pow(' ')");
    assertException(function () {new BigNumber('12.345').pow('2e+1')}, ".pow('2e+1')");
    ...
    assertException(function () {new BigNumber('12.345').pow('1.1e1')}, ".pow('1.1e1')");

    assertException(function () {new BigNumber('12.345').pow(1e9 + 1)}, ".pow(1e9 + 1)");
    assertException(function () {new BigNumber('12.345').pow(1e9 + 0.1)}, ".pow(1e9 + 1)");
